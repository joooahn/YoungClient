 ...
 * @author kyjkim
 */
public class ViewTop3 extends NMapActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        changeSwitch = (Switch) findViewById(R.id.top3static);
        Log.v("TCP","ViewTop3");
        ...
        String sendMessage = "01084069927" + "70" + setting.getString("duration", null);
        ...
        {
            String lngStr = returnMessage.substring(2, 12);
            Log.v("TCP", lngStr);
            lng = Double.parseDouble(lngStr);
            String latStr = returnMessage.substring(12, 22);
            Log.v("TCP", latStr);
            lat = Double.parseDouble(latStr);
        }


        //testPathPOIdataOverlay();// 경로 그려줌
        Log.v("TCP", "onCreate ViewTop3 Finish");
    }
        ...
        if (mMyLocationOverlay != null) {
            ...
            if (mMapLocationManager.isMyLocationEnabled()) {
                ...
                if (!isMyLocationEnabled) { //수신설정x면
                    Log.v("aaa", "10");
                    Toast.makeText(ViewTop3.this, "Please enable a My Location source in system settings",
    ...
    private final OnDataProviderListener onDataProviderListener = new OnDataProviderListener() {
        ...
        public void onReverseGeocoderResponse(NMapPlacemark placeMark, NMapError errInfo) {
            ...
            if (errInfo != null) {
                ...
                Toast.makeText(ViewTop3.this, errInfo.toString(), Toast.LENGTH_LONG).show();
                return;
            }
    ...
    private final NMapLocationManager.OnLocationChangeListener onMyLocationChangeListener = new NMapLocationManager.OnLocationChangeListener() {
        ...
        public void onLocationUpdateTimeout(NMapLocationManager locationManager) {
            ...
            Toast.makeText(ViewTop3.this, "Your current location is temporarily unavailable.", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onLocationUnavailableArea(NMapLocationManager locationManager, NGeoPoint myLocation) {

            Toast.makeText(ViewTop3.this, "Your current location is unavailable area.", Toast.LENGTH_LONG).show();
    ...
    private final NMapView.OnMapStateChangeListener onMapViewStateChangeListener = new NMapView.OnMapStateChangeListener() {
        ...
        public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
            Log.d(LOG_TAG, "onMapInitHandler");
            if (errorInfo == null) { // success
                ...
                poiData.addPOIitem(lat, lng, "GrandParents", markerId, 0);
                poiData.endPOIdata();
                ...
                Toast.makeText(ViewTop3.this, errorInfo.toString(), Toast.LENGTH_LONG).show();
            }
        }
    ...
    private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
        ...
        public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
            ...
            Toast.makeText(ViewTop3.this, "onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
        }
    ...
    private final NMapPOIdataOverlay.OnFloatingItemChangeListener onPOIdataFloatingItemChangeListener = new NMapPOIdataOverlay.OnFloatingItemChangeListener() {
        ...
        public void onPointChanged(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
            ...
            Log.v("aaa", "findPlacemarkAtLocation: " + point.toString());
            findPlacemarkAtLocation(point.longitude, point.latitude);

            item.setTitle("please");
            ...
            if (itemOverlay instanceof NMapPOIdataOverlay) {
                ...
                if (!poiDataOverlay.isFocusedBySelectItem()) {
                    ...
                    if (countOfOverlappedItems > 1) {
                        ...
                        Toast.makeText(ViewTop3.this, text, Toast.LENGTH_LONG).show();
                        return null;
                    }
                }
            }
        ...
        public View onCreateCalloutOverlayView(NMapOverlay itemOverlay, NMapOverlayItem overlayItem, Rect itemBounds) {
            ...
            if (overlayItem != null) {
                ...
                if (title != null && title.length() > 5) {
                    return new NMapCalloutCustomOverlayView(ViewTop3.this, itemOverlay, overlayItem, itemBounds);
                }
            }
    ...
    private void restoreInstanceState() {
        ...
        mMapController.setMapCenter(NMAP_LOCATION_DEFAULT.getLongitude(), NMAP_LOCATION_DEFAULT.getLatitude(), level);
