 ...
 * @author kyjkim
 */
public class SettingHomeLocation extends NMapActivity {
    ...
    private static NGeoPoint NMAP_LOCATION_DEFAULT = new NGeoPoint(126.97838461534991, 37.56661093444756);
    ...
    private static Boolean putConfirmButton = false;
    ...
    private static int MY_PERMISSIONS_REQUEST_SEND_LOCATION = 0;


    private Button confirmButton;
    private double lat = 37.56661093444756;
    private double lng = 126.97838461534991;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        homeLatitude = setting.getString("homeLatitude",null);
        if(homeLatitude==null)
            homeLatitude = String.valueOf(lat);
        homeLongitude = setting.getString("homeLongitude",null);
        if(homeLongitude==null)
            homeLongitude = String.valueOf(lng);

        editor = setting.edit();
//        Log.v("TCP", "Lat: "+ homeLatitude);
//        Log.v("TCP", "Lng: "+ homeLongitude);

        setContentView(R.layout.settinghome);
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SettingHomeLocation.this);     // 여기서 this는 Activity의 this

                // 여기서 부터는 알림창의 속성 설정
                builder.setTitle("위치 확인 대화 상자")        // 제목 설정
                        .setMessage("해당 위치로 설정하시겠습니까?")        // 메세지 설정
                        .setCancelable(true)        // 뒤로 버튼 클릭시 취소 가능 설정
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            // 확인 버튼 클릭시 설정
                            public void onClick(DialogInterface dialog, int whichButton) {
                                editor.putString("homeLatitude", String.valueOf(lat));
                                editor.putString("homeLongitude", String.valueOf(lng));
                                editor.commit();
                                //Log.v("TCP", "SettingHomeLocation: " + String.valueOf(lng) + " " + String.valueOf(lat));
//                                Toast.makeText(SettingHomeLocation.this, "Dialog Confirm" + String.valueOf(lng) + " " + String.valueOf(lat),
//                                        Toast.LENGTH_LONG).show();
                                ...
                                String sendMessage = myPhoneNumber + "30" + sendLatitude + sendLongitude;
        ...
        mOverlayManager.setOnCalloutOverlayViewListener(onCalloutOverlayViewListener); //마커 클릭시 발생하는 이벤트임.
...
//        testFloatingPOIdataOverlay();
        Log.v("TCP", "onCreate SettingHomeLocation Finish");
    }

    @Override
    protected void onStart() {
        Log.v("TCP", "onStart SettingHomeLocation Finish");
        super.onStart();
        // testPOIdataOverlay();
    }
    ...
    protected void onResume() {
        Log.v("TCP", "onResume SettingHomeLocation Finish");
        super.onResume();
    }

    @Override
    protected void onStop() {
        Log.v("TCP", "onStop SettingHomeLocation Finish");
        stopMyLocation();
    ...
    protected void onDestroy() {
        Log.v("TCP", "onDestroy SettingHomeLocation Finish");
    ...
    private void startMyLocation() {
        if (mMyLocationOverlay != null) {
            ...
            if (mMapLocationManager.isMyLocationEnabled()) {
                ...
                Log.v("aaa", "9");
                boolean isMyLocationEnabled = mMapLocationManager.enableMyLocation(true); //GPS수신여부확인
                Log.v("aaa", "asd");
                if (!isMyLocationEnabled) { //수신설정x면
                    Log.v("aaa", "10");
                    Toast.makeText(SettingHomeLocation.this, "Please enable a My Location source in system settings",
                            Toast.LENGTH_LONG).show();

                    Intent goToSettings = new Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS); //GPS설정창 띄운다.
    ...
    private void testPOIdataOverlay() {
        ...
        NMapPOIitem item = poiData.addPOIitem(lat, lng, String.valueOf(lat), markerId, 0);
    ...
    private void testFloatingPOIdataOverlay() {
        // Markers for POI item
        int marker1 = NMapPOIflagType.FROM;
        Log.v("TCP", "testFloatingPOIdataOverlay");
        // set POI data
        NMapPOIdata poiData = new NMapPOIdata(1, mMapViewerResourceProvider);
        poiData.beginPOIdata(1);
        NMapPOIitem item = poiData.addPOIitem(Double.parseDouble(homeLongitude),Double.parseDouble(homeLatitude), "Touch & Drag to Move", marker1, 0);
        if (item != null) {
            Log.v("TCP", "item은 0이 아닙니다.");
...
//            Log.v("TCP", "testFloat: " + String.valueOf(lat) + " " + String.valueOf(lng));
            //  mFloatingPOIitem.setTitle("현재위치로 하시겠습니까?");
        } else
            Log.v("aaa", "item is zero");
        poiData.endPOIdata();
    ...
    private final OnDataProviderListener onDataProviderListener = new OnDataProviderListener() {
        ...
        public void onReverseGeocoderResponse(NMapPlacemark placeMark, NMapError errInfo) {
            ...
            if (errInfo != null) {
                ...
                Toast.makeText(SettingHomeLocation.this, errInfo.toString(), Toast.LENGTH_LONG).show();
                return;
            }
    ...
    private final NMapLocationManager.OnLocationChangeListener onMyLocationChangeListener = new NMapLocationManager.OnLocationChangeListener() {
        ...
        public boolean onLocationChanged(NMapLocationManager locationManager, NGeoPoint myLocation) {
            Log.v("aaa", "onLocationChanged");
            //double d = myLocation.getLatitude();
            lat = myLocation.getLatitude();
            lng = myLocation.getLongitude();


            Log.v("aaa", String.valueOf(myLocation.getLatitude()));
            if (mMapController != null) {
                Log.v("aaa", "startAnimateTo");
        ...
        public void onLocationUpdateTimeout(NMapLocationManager locationManager) {
            ...
            Toast.makeText(SettingHomeLocation.this, "Your current location is temporarily unavailable.", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onLocationUnavailableArea(NMapLocationManager locationManager, NGeoPoint myLocation) {

            Toast.makeText(SettingHomeLocation.this, "Your current location is unavailable area.", Toast.LENGTH_LONG).show();
    ...
    private final NMapView.OnMapStateChangeListener onMapViewStateChangeListener = new NMapView.OnMapStateChangeListener() {
        ...
        public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
            //Log.d("TCP", "onMapInitHandler");
            if (errorInfo == null) { // success
                // restore map view state such as map center position and zoom level.
                mMapController.setMapCenter(Double.parseDouble(homeLongitude),Double.parseDouble(homeLatitude), 14); //초기 시작 좌표
                ...
                NMapPOIitem item =  poiData.addPOIitem(lng, lat, "GrandParents", markerId, 0);
                if (item != null) {
                    // initialize location to the center of the map view.
                    item.setPoint(mMapController.getMapCenter());
                    // set floating mode
                    ...
                    lng = point.getLongitude();
                    lat = point.getLatitude();
                    Log.v("TCP", "testFloat: " + String.valueOf(lng) + " " + String.valueOf(lat));
                    //  mFloatingPOIitem.setTitle("현재위치로 하시겠습니까?");
                } else
                    Log.v("TCP", "item is zero");
                poiData.endPOIdata();
                ...
                Toast.makeText(SettingHomeLocation.this, errorInfo.toString(), Toast.LENGTH_LONG).show();
            }
        }

        @Override
        public void onAnimationStateChange(NMapView mapView, int animType, int animState) {
            Log.d(LOG_TAG, "onAnimationStateChange");
            if (DEBUG) {
        ...
        public void onMapCenterChange(NMapView mapView, NGeoPoint center) {
            Log.d(LOG_TAG, "onMapCenterChange: " + center.toString());
            if (DEBUG) {
    ...
    private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
        ...
        public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
            ...
            Toast.makeText(SettingHomeLocation.this, "onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
        }
    ...
    private final NMapPOIdataOverlay.OnFloatingItemChangeListener onPOIdataFloatingItemChangeListener = new NMapPOIdataOverlay.OnFloatingItemChangeListener() {
        ...
        public void onPointChanged(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
            ...
            lng = point.getLongitude();
            lat = point.getLatitude();
            Log.v("TCP", "onPointChanged: point=" + point.toString());
            ...
            if (itemOverlay instanceof NMapPOIdataOverlay) {
                ...
                if (!poiDataOverlay.isFocusedBySelectItem()) {
                    ...
                    if (countOfOverlappedItems > 1) {
                        ...
                        Toast.makeText(SettingHomeLocation.this, text, Toast.LENGTH_LONG).show();
                        return null;
                    }
                }
            }
        ...
        public View onCreateCalloutOverlayView(NMapOverlay itemOverlay, NMapOverlayItem overlayItem, Rect itemBounds) {
            ...
            if (overlayItem != null) {
                ...
                if (title != null && title.length() > 5) {
                    return new NMapCalloutCustomOverlayView(SettingHomeLocation.this, itemOverlay, overlayItem, itemBounds);
                }
            }
    ...
    private void restoreInstanceState() {
        ...
        mMapController.setMapCenter(lng, lat, level);
